        ...
        <table class="attendance-staff__table">
            ...
            <tbody>
                @foreach($attendances as $attendance)
                    <tr>
                        <td>{{ \Carbon\Carbon::parse($attendance->date)->format('n/j(D)') }}</td>
                        ...
                        <td>{{ $attendance->break_time ? gmdate('H:i', $attendance->break_time * 60) : '-' }}</td>
                        <td>{{ $attendance->total_time ? gmdate('H:i', $attendance->total_time * 60) : '-' }}</td>
                        <td>
